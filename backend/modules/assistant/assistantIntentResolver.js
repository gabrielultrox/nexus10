...
const navigationMap = [
  {
    pattern: /\b(novo pedido|abrir pedidos|ir para pedidos|pedidos)\b/i,
    route: '/orders',
    label: 'Pedidos',
  },
  {
    pattern: /\b(nova venda|abrir vendas|ir para vendas|vendas)\b/i,
    route: '/sales',
    label: 'Vendas',
  },
  {
    pattern: /\b(clientes|abrir clientes|ir para clientes|novo cliente)\b/i,
    route: '/customers',
    label: 'Clientes',
  },
  {
    pattern: /\b(produtos|abrir produtos|ir para produtos)\b/i,
    route: '/products',
    label: 'Produtos',
  },
  {
    pattern: /\b(estoque|abrir estoque|ir para estoque)\b/i,
    route: '/inventory',
    label: 'Estoque',
  },
  {
    pattern: /\b(entregadores|abrir entregadores|ir para entregadores)\b/i,
    route: '/couriers',
    label: 'Entregadores',
  },
]
...
export function resolveAssistantIntent(message) {
  ...
  const isHelpIntent =
    /\b(ajuda|como|diferenca|diferen[a-z]*|funciona|o que e|gerar venda|cadastrar cliente)\b/i.test(
      normalizedText,
    )

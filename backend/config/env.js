...
export const backendEnv = {
  ...
  sentryRelease: required('SENTRY_RELEASE', ''),
  sentryTracesSampleRate: asNumber(process.env.SENTRY_TRACES_SAMPLE_RATE, 0.2),
  monitoringWindowMs: asNumber(process.env.MONITORING_WINDOW_MS, 15 * 60 * 1000),
  alertCooldownMs: asNumber(process.env.ALERT_COOLDOWN_MS, 10 * 60 * 1000),
  alertDiscordWebhookUrl: required('ALERT_DISCORD_WEBHOOK_URL', ''),
  alertErrorRateThresholdPercent: asNumber(process.env.ALERT_ERROR_RATE_THRESHOLD_PERCENT, 5),
  alertLatencyP95ThresholdMs: asNumber(process.env.ALERT_LATENCY_P95_THRESHOLD_MS, 1000),
  alertIfoodWebhookFailureThreshold: asNumber(process.env.ALERT_IFOOD_WEBHOOK_FAILURE_THRESHOLD, 3),

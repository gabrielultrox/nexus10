...
const zeDeliveryConfigSchema = z
  .object({
    ...
    ZE_DELIVERY_WORKER_COUNT: numberSchema(2),
    ...
    ZE_DELIVERY_SCHEDULER_LOG_LEVEL: z.string().trim().default('info'),
...
export function getZeDeliveryConfig(env = process.env) {
  ...
  zeDeliveryConfigCache = {
    ...
    sync: {
      ...
      workerCount: parsed.ZE_DELIVERY_WORKER_COUNT,
    ...
    scheduler: {
      logLevel: parsed.ZE_DELIVERY_SCHEDULER_LOG_LEVEL || 'info',
    },
    selectors: {

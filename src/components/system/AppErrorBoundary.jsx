      ...
      <div className="auth-screen">
        <div className="auth-card">
          ...
          <p className="text-body">
            A tela foi interrompida para evitar uma pagina em branco. Voce pode tentar novamente
            ou recarregar o app.
          </p>
          ...
          <div className="settings-pin-form__actions">
            <button type="button" className="ui-button ui-button--secondary" onClick={this.handleRetry}>
              Tentar novamente
            </button>

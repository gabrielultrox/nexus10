...
function OrdersModule({ orderId, viewMode, formResetToken, onOpenDetail, onOpenEdit, onOpenList }) {
  ...
  const metrics = useMemo(() => {
    ...
    const converted = internalOrders.filter(
      (order) => order.domainStatus === 'CONVERTED_TO_SALE',
    ).length
            ...
            <div className="entity-toolbar-shell">
              <div className="entity-toolbar-copy">
                ...
                <p className="text-body">
                  Filtre por cliente, codigo ou status para localizar o pedido certo com rapidez.
                </p>
              </div>
              ...
              <div className="entity-toolbar">
                ...
                <div className="ui-field">
                  <label className="ui-label" htmlFor="orders-status-filter">
                    Status
                  </label>
                  <Select
                  ...
                  >
                    ...
                    {statusOptions.map((status) => (
                      <option key={status} value={status}>
                        {getOrderDomainStatusLabel(status)}
                      </option>
                    ))}
                  </Select>
                </div>

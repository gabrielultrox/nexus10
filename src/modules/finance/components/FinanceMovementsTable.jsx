          ...
          {rows.map((row, index) => (
            ...
            >
              ...
              <td className="ui-table__cell--muted">
                {row.relatedSaleId || row.cashierName || '-'}
              </td>
              <td
              ...
              <td>
                <span
                  className={`ui-badge ${isFinanceEntryActive(row) ? 'ui-badge--success' : 'ui-badge--warning'}`}
                >
                  {isFinanceEntryActive(row) ? 'Ativa' : row.status}
                </span>
              </td>

...
export const createProductSchema = z.object({
  ...
  stock: z.number().int('Estoque deve ser inteiro.').min(0, 'Estoque nao pode ser negativo.').default(0),
  sku: z.string().trim().min(1, 'SKU e obrigatorio.').max(50, 'SKU deve ter no maximo 50 caracteres.'),
